...
{   
  ...
  {
    // Fill in the code
    TMUberService otherA = (TMUberService) other; // cast the other object to a TMUberService object 
    if (this.type.equals(otherA.type) && this.user.equals(otherA.user)) { // check if the type and user are equal 
      return true;
    }
