...
public class User 
{
  ...
  {
    User otherA = (User) other; // casting the other Object to a User
    if (this.name.equals(otherA.name) && this.address.equals(otherA.address)) { // checking if the name and address are equal 
      return true; 
    }
